...
public final class WebUtil {
    ...
    public static void addCookie(HttpServletRequest request, HttpServletResponse response, String name, String value, Integer maxAge, String path, String domain, Boolean secure) {
        ...
        Assert.notNull(response, "[Assertion failed] - this argument is required; it must not be null");
        Assert.hasText(name, "[Assertion failed] - this String argument must have length; it must not be null or empty");
        try {
